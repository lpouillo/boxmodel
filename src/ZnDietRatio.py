...
class ZnDietRatio(IsotopicBoxModel):
    ...
    def run(self):
        ...
        while len(sweeper.get_remaining()) > 0:
            logger.info(style.comb('Treating combination %s/%s' % 
                                   (i_comb, total_comb)))
    ...
    def set_flux(self, flux_diet, flux_bone):
        k = 0.33
        t = 0.58333
        logger.info('Using flux_diet = ' + str(flux_diet) + ' and flux_bone = '
                    + str(flux_bone))
        self.Flux = {
            "diet": {"diet": 0e0, "plasma": k * flux_diet, "RBC": 0e0,
                     "liver": 0e0, "urine": 0e0, "feces": (1 - k) * flux_diet,
                     "muscle": 0e0, "bone": 0e0, "skin": 0e0, "kidney": 0e0},
            "plasma": {"diet": 0e0, "plasma": 0e0, "RBC": t * 0.18e0,
            ...
            "RBC": {"diet": 0e0, "plasma": t * 0.18e0, "RBC": 0e0,
                    "liver": 0.0e0, "urine": 0e0, "feces": 0e0,
                    "muscle": 0e0, "bone": 0e0, "skin": 0e0, "kidney": 0e0},
            "liver": {"diet": 0e0, "plasma": t * 2.64e0, "RBC": 0e0,
                      "liver": 0e0, "urine": 0e0, "feces": 0e0,
                      "muscle": 0e0, "bone": 0e0, "skin": 0e0, "kidney": 0e0},
            "urine": {"diet": 0e0, "plasma": 0e0, "RBC": 0e0, "liver": 0e0,
                      "urine": 0e0, "feces": 0e0, "muscle": 0e0, "bone": 0e0,
                      "skin": 0e0, "kidney": 0e0},
            "feces": {"diet": 0e0, "plasma": 0e0, "RBC": 0e0, "liver": 0e0,
                      "urine": 0e0, "feces": 0e0, "muscle": 0e0, "bone": 0e0,
                      "skin": 0e0, "kidney": 0e0},
            "muscle": {"diet": 0e0, "plasma": t * 0.0035e0, "RBC": 0e0,
                       "liver": 0e0, "urine": 0e0, "feces": 0e0,
                       "muscle": 0e0, "bone": 0e0, "skin": 0e0, "kidney": 0e0},
            "bone": {"diet": 0e0, "plasma": flux_bone, "RBC": 0e0,
                     "liver": 0e0, "urine": 0e0, "feces": 0e0, "muscle": 0e0,
                     "bone": 0e0, "skin": 0e0, "kidney": 0e0},
            "skin": {"diet": 0e0, "plasma": 0e0, "RBC": 0e0, "liver": 0e0,
                     "urine": 0e0, "feces": 0e0, "muscle": 0e0, "bone": 0e0,
                     "skin": 0e0, "kidney": 0e0},
            "kidney": {"diet": 0e0, "plasma": 0.5 * k * flux_diet, "RBC": 0e0,
    ...
    def parameters(self):
        ...
        self.Boxes = {"diet":     {'Delta':    0e0, 'Mass':  1e12},
        ...
        self.Partcoeff = {
            "diet":   {"diet": 1.0, "plasma": 1.00018e0, "RBC": 1e0,
            ...
            "urine":  {"diet": 1.0, "plasma": 1e0, "RBC": 1e0, "liver": 1e0,
                       "urine": 1e0, "feces": 1e0, "muscle": 1e0,
                       "bone": 1e0, "skin": 1e0, "kidney": 1e0},
